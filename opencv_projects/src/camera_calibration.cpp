...
* ref : https://docs.opencv.org/4.1.0/d9/d0c/group__calib3d.html#ga93efa9b0aa890de240ca32b11253dd4a : sample usage of detecting and drawing chessboard corners section in this link
* ref : https://docs.opencv.org/4.1.0/dd/d1a/group__imgproc__feature.html#ga354e0d7c86d0d9da75de9b9701a9a87e : for cornerSubPix() function definition
* ref : https://docs.opencv.org/3.4/da/d54/group__imgproc__transform.html#ga47a974309e9102f5f08231edc7e7529d : resize() api for image in opencv
*/
...
int main()
{
    ...
    while(1)
    {
        ...
        // resize the live feed to 320 width and 240 height image , we do not need other optional parameters of this resize api
        resize(original_live_camera_frame, live_camera_frame, Size(426,240)); 
